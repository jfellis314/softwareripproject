...
public class Desk_TodayAppoint {
	...
	Parent admin = FXMLLoader.load(getClass().getResource("Desk_CheckedINAppoint.fxml"));
	...
	public void btnNextClicked(ActionEvent event) throws IOException{
		Parent admin = FXMLLoader.load(getClass().getResource("Desk_UnscheduledOrder.fxml"));
		Scene scene = new Scene(admin);
		Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
