...
public class Tech_AllAppoint extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Tech_AllAppoint frame = new Tech_AllAppoint();
	...
	public Tech_AllAppoint() {
		...
		changePane.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				Tech_CheckedINAppoint techPages=new Tech_CheckedINAppoint();
		...
		JLabel lblNewLabel_5 = new JLabel("Checked-In Appointments");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_5.setBounds(900, 750, 168, 31);
