...
public class Desk_TodayAppoint extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Desk_TodayAppoint frame = new Desk_TodayAppoint();
	...
	public Desk_TodayAppoint() {
		...
		JLabel lblNewLabel_1 = new JLabel("Today's Appointments");
		...
		JLabel lblNewLabel_4 = new JLabel("2 / 3");
		...
		changePane.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
				Desk_UnscheduledOrder adminPages=new Desk_UnscheduledOrder();
		...
		JLabel lblNewLabel_5 = new JLabel("Unscheduled Orders");
		lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_5.setBounds(900, 750, 127, 31);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_3 = new JLabel("Checked-In Appointments");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblNewLabel_3.setBounds(562, 750, 168, 31);
		...
		lblNewLabel_3_1_1_1_1_1_1.setBounds(1280, 158, 101, 17);
